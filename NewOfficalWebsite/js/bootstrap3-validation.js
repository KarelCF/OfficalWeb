...
!function($) {
   ...
   $.fn.validation.defaults = {
        validRules : [
            ...
            {name: 'tel', validate: function(value) {return (!/^((\d{11})|^((\d{7,8})|\(?(\d{4}|\d{3})\)?(\d{7,8})|(\d{4}|\d{3})-(\d{7,8})|(\d{4}|\d{3})-(\d{7,8})-(\d{4}|\d{3}|\d{2}|\d{1})|(\d{3,4}-\d{3}-\d{3})|(\d{7,8})-(\d{4}|\d{3}|\d{2}|\d{1}))$)/.test(value));}, defaultMsg: '请输入正确的电话号码,方便活动发起者与您联系'}
        ],
        reqmark:true,
